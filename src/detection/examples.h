...
char exit_0_syscall [] = "\x90\x90\x90\x90\x90\x90\x90\x90\x90\x90\x90"  "\xb8\x01\x00\x00\x00\x31\xdb\xcd\x80";
int size_exit_0_syscall = 20;

char *nop_buffer= "\x90\x90\x90\x90\x90\x90\x90";
int size_nop_buffer = 7;

char *bucle_1 = /* bucle for simple con llamada write dentro */
...
char *admmutate_1 = /* tiene unos writes dentro */ 
